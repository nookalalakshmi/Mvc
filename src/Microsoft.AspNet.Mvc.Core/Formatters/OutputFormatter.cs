...
namespace Microsoft.AspNet.Mvc
{
    ...
    public abstract class OutputFormatter : IOutputFormatter
    {
        ...
        /// <summary>
        /// Sets the headers on the <see cref="Microsoft.AspNet.Http.HttpResponse"/> object.
        /// </summary>
        /// <param name="context">The formatter context associated with the current request.</param>
