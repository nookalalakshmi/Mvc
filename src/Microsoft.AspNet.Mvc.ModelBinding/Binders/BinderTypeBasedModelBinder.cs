...
{
    /// <summary>
    /// An <see cref="IModelBinder"/> which understands <see cref="ICustomModelBinderMetadata"/> and uses
    /// the supplied <see cref="IModelBinder"/> or <see cref="IModelBinderProvider"/> bind the model.
    /// </summary>
