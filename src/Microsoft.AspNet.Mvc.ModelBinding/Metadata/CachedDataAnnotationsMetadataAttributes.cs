...
namespace Microsoft.AspNet.Mvc.ModelBinding
{
    public class CachedDataAnnotationsMetadataAttributes
    {
        public CachedDataAnnotationsMetadataAttributes(IEnumerable<object> attributes)
        {
            ...
            PropertyBindingInfo = attributes.OfType<IPropertyBindingInfo>().ToList();
            BinderModelNameProvider = attributes.OfType<IModelNameProvider>().FirstOrDefault();
            BinderTypeProviders = attributes.OfType<IBinderTypeProviderMetadata>().ToList();
        ...
        /// <summary>
        /// Gets (or sets in subclasses) <see cref="IReadOnlyList{IBinderTypeProviderMetadata}"/> found in collection passed
        /// to the <see cref="CachedDataAnnotationsMetadataAttributes(IEnumerable{object})"/> constructor, if any.
        /// </summary>
        public IReadOnlyList<IBinderTypeProviderMetadata> BinderTypeProviders { get; set; }
